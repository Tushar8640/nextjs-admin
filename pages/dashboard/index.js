  ...
  return (
    <>
      ...
      <section className="p-6 my-6 bg-gray-100 text-gray-800">
        <div className="container grid grid-cols-1 gap-2 mx-auto sm:grid-cols-2 xl:grid-cols-4">
          <div className="flex p-4 space-x-2 rounded-lg md:space-x-6 bg-gray-50 text-gray-800">
